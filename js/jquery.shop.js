(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "Monsoon-https://monsoonmalabar.com/velmurugan-"; // Prefix string to be prepended to the cart's name in the session storage
